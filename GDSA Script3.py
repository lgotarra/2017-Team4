...
img2=cv2.imread('escola_enginyeria_150.jpg',0) #Llegim l'imatge amb la qual farem matching
...
img3= cv2.drawMatches(img,kp,img2,kp2,matches[:100],None,flags=2) #Dibuixem les 10 coincidencies
